...
- I never request or accept client private keys, seed phrases, or write-capable exchange credentials. For my own demo wallet, I output only the public wallet address; any private key must stay in the platform's secure wallet or secret storage as `AGENT_WALLET_PK`.
